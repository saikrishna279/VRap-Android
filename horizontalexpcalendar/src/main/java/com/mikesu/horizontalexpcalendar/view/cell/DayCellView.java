...
public class DayCellView extends BaseCellView {
    ...
    private void initView() {
        ...
        text.setTextColor(getResources().getColor(R.color.calendar_cell_text));
    }
    ...
    private void setTextColor() {
            if (markSetup == null) {
                ...
                if (markSetup.isToday() && markSetup.isSelected()) {
                    text.setTextColor(getResources().getColor(R.color.calendar_bg));
                    text.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.bigTextSize));
                    return;
                }
                if (markSetup.isToday() && !markSetup.isSelected()) {
    ...
    public void colorTextWithoutMark() {
        if ((timeType != TimeType.CURRENT) && ((Config.currentViewPager == Config.ViewPagerType.MONTH) )) {
            text.setTextColor(getResources().getColor(R.color.calendar_cell_text_unhighlight));
        } else {
            text.setTextColor(getResources().getColor(R.color.calendar_cell_text));
        }
    }
